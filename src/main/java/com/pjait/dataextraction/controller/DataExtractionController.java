...
import com.pjait.dataextraction.service.KafkaDataProducerService;
...
public class DataExtractionController {
    ...
    private KafkaDataProducerService kafkaDataProducerService;
    ...
    @Autowired
    public void setKafkaProducerService(KafkaDataProducerService kafkaDataProducerService) {
        this.kafkaDataProducerService = kafkaDataProducerService;
    }
    ...
    private int extractData(String postUrl) throws JsonProcessingException {
        ...
        historicalDataList.forEach(data -> kafkaDataProducerService.sendMessage(data));
